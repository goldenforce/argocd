...
*/}}
{{- define "annotationsLabelsIngressNlbUiAws" -}}
...
ui:
  annotations:
    ...
    #nginx.ingress.kubernetes.io/whitelist-source-range: {{ $.Values.ingresses.lb.whiteListedIPs | quote }}
...
*/}}
{{- define "annotationsLabelsIngressNlbOrchestratorAws" -}}
{{- $annotationsLabelsCommon := include "annotationsLabels" . | fromYaml }}
orchestrator:
  annotations:
    # Include common annotations
...
*/}}
{{- define "annotationsLabelsIngressNlbDatabaseAws" -}}
{{- $annotationsLabelsCommon := include "annotationsLabels" . | fromYaml }}
database:
  annotations:
    # Include common annotations
